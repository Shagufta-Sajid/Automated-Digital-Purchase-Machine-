...
<h2>Recently Searched Customer's Record:</h2>
</div>
...
$num= $_POST['id'];
 ...
 $s="SELECT name,SUM(price) as total_bill, purchase_datetime FROM purchase WHERE phone='".$num."' ORDER BY purchase_datetime DESC;";
...
if($q)
{
    if (mysqli_num_rows($q) > 0)
...

            {
                ...
                echo'<td>'.$row["purchase_datetime"].'</td>';
                echo'</tr>';
